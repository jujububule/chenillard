...
Le process permet de définir les entrées et sorties que l'on vas faire changer d'état dans le case.

On doit donc l'utiliser lorsqu'on fait changer d'état n'importe quelles entrées et sorties.
# Les modes LEDs :
## Mode 1.1 :
